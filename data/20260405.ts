...
export const FAILURE_TRANSMISSION: TransmissionData = {
    ...
    entries: [
        ...
        {
            timestamp: "[0:50 — 1:05]",
            quote: "Nine stages. Every single one of them designed to displace me from myself, from the record, from the truth.",
            commentary: "Not nine stages designed to remove him from a park. Nine stages designed to displace him from himself, from the record, from the truth. That is the deeper function of displacement — it is not about location. It is about identity and legibility.",
        },
        {
            timestamp: "[1:05 — 1:22]",
        ...
        },
        {
            ...
            commentary: "He names what the platform is: infrastructure against displacement from self. Not a website — a structural defense. The archive, the signal system, the framework — built so that no institution could erase who he is or what he documented. They sent police to a locked federal gate. That is how far they went. And it still was not enough.",
        },
        {
            timestamp: "[1:52 — 2:16]",
            quote: "There's one other thing I want to say about this. You did everything you did all nine stages over nonsense because one park supervisor didn't like me and you backed her up all the way up your hierarchy to the governor of the state and then cross agency lines to try to silence me.",
            commentary: "He names the absurdity. Nine stages of institutional displacement — coercion, surveillance, dismissal, expulsion, police intimidation — because one supervisor did not like him. And the entire hierarchy backed her. From the park to the governor's office. Across agency lines. To silence one volunteer who documented what they did.",
        },
        {
            timestamp: "[2:16 — 2:25]",
        ...
        },
        {
            ...
            commentary: "The displacement framework is a direct consequence of their refusal to stop. He came to steward land. They forced him to understand institutional abuse. The framework — the naming of the weapon, the nine stages, the structural analysis — exists because they would not stop. Their failure to break him produced the very thing that makes the pattern legible to others.",
        },
        {
            timestamp: "[3:05 — 3:25]",
