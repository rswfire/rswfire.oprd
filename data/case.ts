...
export const CASE_CARDS: CaseCard[] = [
    {
        ...
        typeLabel: "Email",
        title: "The letter that named it.",
    ...
    },
    {
        ...
        title: "The meeting that followed.",
    ...
    },
    {
        ...
        title: "The call that confirmed it.",
    ...
    },
    {
        ...
        authorLabel: "Program Manager, OPRD",
        typeLabel: "Letter",
        title: "The letter that made it permanent.",
