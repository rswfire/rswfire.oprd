        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="rounded-xl border border-slate-200 shadow-sm bg-white p-4">
                    ...
                    <div className="text-sm text-gray-700 mt-3 pt-3 border-t border-gray-200"><strong>62 minutes at a public picnic table.</strong> The <PersonLink name="park manager" /> told me to <em>chew glass and swallow it</em>. He admitted I was never given the benefit of the doubt from day one. I recorded every word.</div>
                ...
                <div className="rounded-xl border border-slate-200 shadow-sm bg-white p-4">
                    ...
                    <div className="text-sm text-gray-700 mt-3 pt-3 border-t border-gray-200"><strong>30 minutes and 56 seconds.</strong> The <PersonLink name="program manager" /> weaponized personal disclosures to characterize me as paranoid and delusional. She ignored every declaration of inappropriate treatment.</div>
                    <div className="mt-3 pt-3 border-t border-gray-200 text-sm">
            ...
            <div className="rounded-xl border border-slate-200 shadow-sm bg-white p-4">
                ...
                <div className="text-sm text-gray-700 mt-3 pt-3 border-t border-gray-200"><strong>March 24, 2025.</strong> Dismissed by the <PersonLink name="park manager" />, then two days later expelled by the <PersonLink name="program manager" /> from all Oregon State Parks &mdash; in writing &mdash; for speaking publicly about abuse. That is First Amendment retaliation. On state agency letterhead. With a signature.</div>
