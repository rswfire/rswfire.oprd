...
export default function AdvocateLetter() {
    return (
        <div className="mt-6 max-h-[500px] overflow-y-auto border border-slate-200 rounded-lg p-6 bg-white shadow-sm">
            ...
            <div className="space-y-4 text-base leading-relaxed">
                ...
                <h3 className="text-lg font-bold uppercase tracking-widest text-gray-900">What They Did</h3>
                ...
                <h3 className="text-lg font-bold uppercase tracking-widest text-gray-900">Why They Did It</h3>
                ...
                <h3 className="text-lg font-bold uppercase tracking-widest text-gray-900">What Happened When I Tried to Get Accountability</h3>
                ...
                <h3 className="text-lg font-bold uppercase tracking-widest text-gray-900">What They Did on the Anniversary</h3>
                ...
                <h3 className="text-lg font-bold uppercase tracking-widest text-gray-900">What This Case Is Actually About</h3>
                ...
                <h3 className="text-lg font-bold uppercase tracking-widest text-gray-900">The Record</h3>
