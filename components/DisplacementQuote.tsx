// components/DisplacementQuote.tsx
export default function DisplacementQuote() {
    return (
        <blockquote className="border-l-4 border-emerald-600 pl-6 py-4 my-8 max-w-2xl">
            <p className="text-xl font-serif text-gray-900 leading-relaxed italic">
