...
export const LENSES: { type: LensType; label: string; blurb: string }[] = [
    ...
    { type: "SYMBOLIC", label: "Symbolic", blurb: "The record read through archetype and symbol — the recurring pattern beneath the particulars." },
    ...
    { type: "MIRROR", label: "Mirror", blurb: "The record turned back on the one who kept it — what it shows him about himself." },
    { type: "SHAPE", label: "Shape", blurb: "The person read across the whole record — what changed in him over its span, and what did not move." },
    { type: "SYSTEMIC", label: "Systemic", blurb: "The record read as a system under load — its binding constraint, and how the pattern operates." },
];
