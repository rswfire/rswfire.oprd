            ...
            <div className="mt-8 space-y-8">
                ...
                <div id="epistemic" className="scroll-mt-48">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>It's not just lying. It's the insistence that <em>their</em> account has more authority than what actually happened to you. This is what Ryan Warren meant <Link href="/evidence/coercion" className="text-emerald-700 underline hover:text-emerald-600">by &quot;chew glass and swallow it.&quot;</Link></div>
