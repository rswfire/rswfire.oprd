            ...
            <div className="mt-8 space-y-8">
                ...
                <div id="next" className="scroll-mt-48">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>The <Link href="/records" className="text-emerald-700 underline hover:text-emerald-600">correspondence section</Link> will continue to record each response, refusal, production, and correction.</div>
