// app/(archive)/trust-broken/supplemental/page.tsx
...
export default function TrustBrokenSupplementalPage() {
    return (
        <SectionPage
            title="TRUST BROKEN"
        ...
        >
            ...
            <div className="mt-8 pt-6 border-t border-gray-300">
                <Link href="/trust-broken" className="text-emerald-700 hover:underline">
                    ← Back to Trust Broken
                </Link>
            </div>
