...
export const metadata: Metadata = {
    title: "Coercion",
    description: "March 5, 2025 - Over an hour of recorded psychological pressure by the park manager and the park supervisor.",
};
...
export default function CoercionPage() {
    return (
        <SectionPage
            ...
            summary="The park manager and the park supervisor summoned me to a public picnic table for over an hour of psychological pressure designed to force my resignation."
        ...
        >
            ...
            <div className="mt-4 space-y-4 text-base text-gray-700 leading-relaxed">
                ...
                <div>The <PersonLink name="park supervisor" /> was silent for the first 19 minutes. Her first word was &ldquo;tone&rdquo; &mdash; spoken once, precisely timed, reframing every email I had ever written as threatening. She said nothing while the park manager told me to chew glass. She said nothing while he mocked my sexuality. She said nothing while he admitted he had never given me the benefit of the doubt.</div>
                <div>When the park manager&rsquo;s admission destabilized his own argument, she attacked. Fifty minutes in, she returned to the only thing they ever had: a text message from the first week of February that we had already resolved. She confirmed on tape that she had invented an interpretation of my job application withdrawal email &mdash; attaching meaning that was never there, that I had never stated, that existed in no correspondence &mdash; and brought it to that table as evidence against me.</div>
