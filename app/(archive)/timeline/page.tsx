            ...
            <ul className="space-y-6 border-l-2 border-emerald-600 ml-6 pl-6 mt-4">
                <li>
                    ...
                    <div className="mt-2 text-sm">
                        ...
                        </Link> to operational questions about power outage protocols. I send follow-up email naming her tone. Same day: <Link href="/response" className="underline text-emerald-800 hover:text-emerald-600">Ryan Warren confronts me alone</Link>, cataloging first-week mistakes. I try to reset.
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div className="mt-2 text-sm">
                        <Link href="/coercion" className="underline text-emerald-800 hover:text-emerald-600">
                ...
                <li>
                    ...
                    <div className="mt-2 text-sm">
                        <Link href="/dismissal" className="underline text-emerald-800 hover:text-emerald-600">
                ...
                <li>
                    ...
                    <div className="mt-2 text-sm">
                        <Link href="/expulsion" className="underline text-emerald-800 hover:text-emerald-600">
                ...
                <li>
                    ...
                    <div className="mt-2 text-sm">
                        I send <Link href="/expulsion" className="underline text-emerald-800 hover:text-emerald-600">detailed letter to Allison</Link> attempting accountability. Hours later: permanent dismissal from all Oregon State Parks volunteer programs, explicitly citing my public speech about the abuse.
                    </div>
                </li>
            </ul>
