// app/(archive)/records/[slug]/[ulid]/page.tsx
//
...
export async function generateMetadata({
    ...
    return {
        ...
        description,
        alternates: { canonical: `/record/${slug}/${ulid}/` },
        openGraph: {
            type: "article",
            title: `${filing.title} — ${filing.date}`,
            description,
            url: `/record/${slug}/${ulid}/`,
        },
    };
}
        ...
        <SectionPage
            ...
            previousPage={
                prev
                    ...
                    : { href: `/records/${slug}`, label: thread.title }
            }
            nextPage={
                next
                    ? { href: `/record/${slug}/${next.ulid}`, label: "Next document" }
                    : { href: "/records", label: "The Records" }
            }
        >
