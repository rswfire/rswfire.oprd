...
export const metadata: Metadata = {
    ...
    description:
        "The thirteen primary signals of this archive, clustered on Autonomy Realms and read together across six analytical lenses.",
};
...
export default function RecordPage() {
    return (
        <SectionPage
            title="THE OPRD RECORD"
            subtitle="THIRTEEN SIGNALS, READ TOGETHER"
        ...
        >
            <div className="mb-6 space-y-4 text-base">
                <div>
                    ...
                    as a signal &mdash; transcribed, analyzed, and independently addressable. This page holds those
                    thirteen signals as one cluster: the record from the recorded picnic-table meeting of March 5,
