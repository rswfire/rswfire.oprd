...
export default function NamingTheHarmPage() {
    return (
        <SectionPage
            title="NAMING THE HARM"
            subtitle="MAY-AUGUST 2025 — THE LETTERS THEY MUST RECKON WITH"
        >

            <div className="mt-4">
                After months of institutional silence, I sent two letters naming the harm directly to those
                who caused it. Not as requests for apology or repair—but as statements of record.
            </div>
            ...
            <div className="mt-4">
                Two months and one day after my vulnerable follow-up letter was met with silence, I named
                the full scope of harm Allison Watson caused through institutional protection and
            ...
            >
                ...
                <div className="mt-4">
                    I am writing to formally name the harm that occurred under your leadership — and to
                ...
                <div>
                    And now, for the first time, others can hear what I heard — the tone, the silences, the
    ...
    <div className="mt-4">
        Instead, less than twenty-four hours later, you made my dismissal permanent — a decision
    ...
    <div className="mt-4">
        You shielded misconduct by refusing to investigate or intervene — permitting coercive
        behavior and inappropriate power dynamics to persist under your leadership.
    </div>

    <div className="mt-4">
        You sanctioned erasure — not only of my role, but of the narrative I offered in good
        faith.
    </div>
    ...
    <div className="mt-4">
        ...
        coerced — ensuring they remain unaccountable.
    </div>
    ...
    <div>
        You made yourself the endpoint — not a bridge, not a voice of integrity, but a terminus.
        A silence.
    </div>
    ...
    <div>
        I'm naming that it happened — and ensuring that the record will outlast the silence
        that followed.
    </div>
    ...
    <div className="mt-4">
        Three months later, I named the harm Kati Baker caused by weaponizing vulnerability and
        using institutional authority to punish what she refused to understand.
    </div>

    <Email
        from="Sam White"
        to="Kati Baker"
        cc="Allison Watson, Lisa Sumption"
    ...
    >
        ...
        <div className="mt-4">
            ...
            wound inflicted on you. You were performing, of course — and I knew this even as I
        ...
        <div className="mt-4">
            ...
            dangerous. That move — conscious or not — disfigured what might have been possible
            between us.
        </div>
        ...
        <div className="mt-4">
            ...
            whether there's any space in this institution for someone like me — someone unwilling to
        ...
        <div className="mt-4">
            ...
            require integrity, humility, and discernment — and instead, you acted to protect your own
    ...
    <div className="mt-8 pt-6 border-t">
        <div className="mt-4">
            Neither letter received a response. Neither needed one.
        </div>
        ...
        <div className="mt-4">
            ...
            person named here will carry their choice forward—whether they acknowledge it or not.
        </div>
    </div>
