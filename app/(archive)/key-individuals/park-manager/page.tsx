// app/(archive)/key-individuals/park-manager/page.tsx
...
export default function ParkManagerPage() {
    return (
        <SectionPage
            ...
            previousPage={{ href: "/key-individuals/park-supervisor", label: "Park Supervisor" }}
            nextPage={{ href: "/key-individuals/program-manager", label: "Program Manager" }}
        >

            <blockquote className="border-l-4 border-gray-900 pl-6 py-2 mb-12 text-lg leading-relaxed">
                The <PersonLink name="park supervisor" /> orchestrated it. He executed it without question. Everyone else operated with institutional calculation. He operated with volatility barely contained.
            </blockquote>
            ...
            <AccountabilityRecord
                heading="Correspondence with the park manager"
                intro="The correspondence to and from the park manager. Each document opens here and links to its place on the accountability pages."
                items={withPerson("[Park Manager]")}
            />
