// app/(archive)/key-individuals/program-manager/page.tsx
...
export const metadata: Metadata = {
    ...
    description: "Program Manager, OPRD — named retaliation for protected speech in writing on agency letterhead.",
};
...
export default function ProgramManagerPage() {
    return (
        <SectionPage
            title="PROGRAM MANAGER"
            subtitle="OREGON PARKS & RECREATION DEPARTMENT"
            previousPage={{ href: "/key-individuals/park-manager", label: "Park Manager" }}
        ...
        >
            ...
            <div className="space-y-6 text-base text-gray-700 leading-relaxed mb-8">
                ...
                <div>
                    ...
                    <div className="mt-2">
                        She weaponized <Link href="/evidence/trust" className="underline text-emerald-800 hover:text-emerald-600">the volunteer services lead&rsquo;s disclosures</Link> to frame me as paranoid and delusional. She claimed I had shared that &ldquo;a staff member would be used to kill you when the end of the world occurs&rdquo; &mdash; a fabrication. I have never believed the world was ending. I have never said anything resembling this to anyone. I told her I had no idea what she was talking about. She proceeded anyway.
                    </div>
                    <div className="mt-2">
                        I told her about the glass. About the benefit of the doubt admission. About the coercive exit attempts. About the <PersonLink name="volunteer services lead" />&rsquo;s boundary violations. She responded to each with &ldquo;okay&rdquo; and moved to the next item on her agenda. At minute 26, I built her a door &mdash; I acknowledged learning, offered to adjust, named my positive intent. She said &ldquo;thank you for sharing that&rdquo; and proceeded to what was always going to happen next.
                    </div>
                    <div className="mt-2">
            ...
            <AccountabilityRecord
                heading="Correspondence with the program manager"
                intro="The correspondence to and from the program manager. Each document opens here and links to its place on the accountability pages."
                items={withPerson("[Program Manager]")}
            />
