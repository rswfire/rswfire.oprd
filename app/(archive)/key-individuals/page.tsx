    ...
    return (
        ...
        >
            ...
            <ul className="mt-4 list-disc list-outside ml-8 space-y-2">
                ...
                <li>Betrayed <Link href="/evidence/betrayal" className="underline text-emerald-800 hover:text-emerald-600">supervisory trust</Link>.</li>
            </ul>
            ...
            <ul className="mt-4 list-disc list-outside ml-8 space-y-2">
                ...
                <li><Link href="/evidence/betrayal" className="underline text-emerald-800 hover:text-emerald-600">Weaponized Logan's disclosures</Link> to mock my sexuality at day-use meeting.</li>
            ...
            <ul className="mt-4 list-disc list-outside ml-8 space-y-2">
                ...
                <li><Link href="/evidence/betrayal" className="underline text-emerald-800 hover:text-emerald-600">Used Logan's disclosures</Link> to construct psychological profile, reframed analysis as &quot;apocalyptic thinking.&quot;</li>
