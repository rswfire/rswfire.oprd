...
export default function KeyIndividualsPage() {
    return (
        ...
        >
            ...
            <h2 className="mt-8 text-xl font-semibold"><PersonLink name="volunteer services lead" label="VOLUNTEER SERVICES LEAD" /></h2>
            <div className="mt-2 italic">
                Honeyman State Park
            </div>
            <ul className="mt-4 list-disc list-outside ml-8 space-y-2">
                <li>My direct supervisor, reported to the <PersonLink name="park supervisor" /> and the <PersonLink name="park manager" />.</li>
                <li>Spent 90 minutes eliciting trust through reciprocal vulnerability.</li>
                <li>Transmitted confidential disclosures to the <PersonLink name="park supervisor" />, the <PersonLink name="park manager" />, and the <PersonLink name="program manager" />.</li>
                <li>Escalated situation with the <PersonLink name="park supervisor" /> instead of protecting me.</li>
            ...
            <h2 className="mt-8 text-xl font-semibold"><PersonLink name="park supervisor" label="PARK SUPERVISOR" /></h2>
            <div className="mt-2 italic">
                Honeyman State Park
            </div>
            <ul className="mt-4 list-disc list-outside ml-8 space-y-2">
                ...
                <li>Receiver of confidential disclosures the <PersonLink name="volunteer services lead" /> transmitted from me.</li>
                <li>March 5: present during the <PersonLink name="park manager" />&rsquo;s coercive meeting, remained silent, intervened only when he made damaging admissions.</li>
            ...
            <h2 className="mt-8 text-xl font-semibold"><PersonLink name="park manager" label="PARK MANAGER" /></h2>
            <div className="mt-2 italic">
                Honeyman State Park
            </div>
            <ul className="mt-4 list-disc list-outside ml-8 space-y-2">
                ...
                <li><Link href="/evidence/trust" className="underline text-emerald-800 hover:text-emerald-600">Weaponized the volunteer services lead's disclosures</Link> to mock my sexuality at day-use meeting.</li>
            ...
            <h2 className="mt-8 text-xl font-semibold"><PersonLink name="program manager" label="PROGRAM MANAGER" /></h2>
            <div className="mt-2 italic">
            ...
            <ul className="mt-4 list-disc list-outside ml-8 space-y-2">
                ...
                <li><Link href="/evidence/trust" className="underline text-emerald-800 hover:text-emerald-600">Used the volunteer services lead's disclosures</Link> to construct psychological profile, weaponized disclosures to frame me as paranoid and delusional.</li>
            ...
            <ul className="mt-4 list-disc list-outside ml-8 space-y-2">
                ...
                <li><Link href="/lisa-sumption/closure" className="underline text-emerald-800 hover:text-emerald-600">Closed communication one day before full scope of the volunteer services lead's betrayal and weaponization of queer identity was published</Link>.</li>
